...
class DatabaseUtility:
	...
	DatabaseInfo = 'host = localhost'+' dbname='+dbname+' user='+user+' password='+password
    ...
    def merge_tables(self):
        try:
            ...
            sql = 'INSERT INTO "public".sensordata_revived SELECT "public".sensordata_revived2.datetime, "public".sensordata_revived2.measurement, "public".sensordata_revived2.sensor_sn FROM "public".sensordata_revived FULL OUTER JOIN "public".sensordata_revived2 ON "public".sensordata_revived.datetime = "public".sensordata_revived2.datetime AND "public".sensordata_revived.measurement = "public".sensordata_revived2.measurement AND "public".sensordata_revived.sensor_sn = "public".sensordata_revived2.sensor_sn WHERE "public".sensordata_revived.measurement IS NULL;'
    ...
    def copy_data_into_database(self, insertFilename, tableName, \
        ...
        try:
            ...
            #at the psql prompt
            #sql = "COPY sensordata_revived2 FROM '" + os.path.abspath(insertFilename) + "' " + "DELIMITER ',' CSV;"
            self.cur.execute(sql)
