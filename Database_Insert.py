...
temp_table   = "sensordata_revived2"
...
for target in os.listdir(data_folder):
    ...
    if target.endswith(".csv"):
        ...
        #empty secondary table
        A.truncate_table(temp_table)
        #copy targe file into secondary table
        A.copy_data_into_database(target, temp_table, table_fields)
        #merge secondary table to primary table
        A.merge_tables()
